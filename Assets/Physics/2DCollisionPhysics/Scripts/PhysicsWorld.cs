...
namespace CustomPhysics {
    ...
    public class PhysicsWorld : IPhysicsWorld {
        ...
        public void Init() {
            ...
            closestCalc = BurstCompiler.CompileFunctionPointer<PhysicsTool.GetClosestPointToOriginDelegate>(PhysicsTool.GetClosestPointToOrigin).Invoke;
            perpCalc = BurstCompiler.CompileFunctionPointer<PhysicsTool.GetPerpendicularToOriginDelegate>(PhysicsTool.GetPerpendicularToOrigin).Invoke;
            createEdgeCalc = BurstCompiler.CompileFunctionPointer<PhysicsTool.CreateEdgeDelegate>(PhysicsTool.CreateEdge).Invoke;
            checkCircleCalc = BurstCompiler.CompileFunctionPointer<PhysicsTool.CheckCircleCollidedDelegate>(PhysicsTool.CheckCircleCollided).Invoke;
        }
